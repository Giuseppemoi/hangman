(() => {
    ...
    // // tete
    // ctx.lineWidth="4";
    // ctx.strokeStyle="#31528C";
    // ctx.beginPath();
    // ctx.arc(150, 85, 15, 0, 2*Math.PI);
    // ctx.stroke();
    ...
    document.addEventListener("keydown", (event)=> {
        ...
        if (arrayLetters.indexOf(letter) >= 0) { 
